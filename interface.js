...
function generateInterface(listFile) {
    ...
    <br>
    <br>
    <form id="box" action="https://mutationexplorer-beta.vda-group.de/mutation_explorer/interface_post" method="post" enctype="multipart/form-data" target="_blank" style="margin-left: 20px">
